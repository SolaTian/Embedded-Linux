- [WatchDog](#watchdog)
  - [Watchdog 的分类](#watchdog-的分类)
  - [软狗 Software Watchdog](#软狗-software-watchdog)
    - [单任务系统中的软狗](#单任务系统中的软狗)
    - [多任务系统中的软狗](#多任务系统中的软狗)
    - [心跳机制实现软狗](#心跳机制实现软狗)
    - [心跳机制与子看门狗的比较](#心跳机制与子看门狗的比较)
    - [心跳机制的优势](#心跳机制的优势)
    - [软件看门狗复位举例](#软件看门狗复位举例)
  - [硬狗 Hardware Watchdog](#硬狗-hardware-watchdog)
    - [硬件看门狗的工作原理](#硬件看门狗的工作原理)
    - [硬件看门狗的特点](#硬件看门狗的特点)
    - [硬件看门狗复位举例](#硬件看门狗复位举例)
      - [主进程内存泄露或者 OOM 导致系统反复重启](#主进程内存泄露或者-oom-导致系统反复重启)
      - [判断系统由于哪种看门狗复位](#判断系统由于哪种看门狗复位)
